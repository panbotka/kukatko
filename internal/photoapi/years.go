...
//
// It accepts the same filter query parameters as GET /photos (archived, private,
...
// visibility is therefore enforced by the same clauses as the list: archived and
// private photos are counted only when the caller asks for them.
//
