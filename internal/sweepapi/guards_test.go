...
// TestGuards_curatorReachesTheSweep proves the sweep hangs on RequireCurator: a curator
// and an editor pass its guard, a viewer is refused.
func TestGuards_curatorReachesTheSweep(t *testing.T) {
	t.Parallel()
	routes := []guardedRoute{
		{http.MethodGet, "/faces/sweep", true},
	}
