...
// SetFlag sets the personal mark (eye/thumbs-up/thumbs-down) photoUID has for the
// user identified by userUID, leaving any existing rating untouched. The stored
// flag string is validated against RatingFlag. It is an idempotent upsert;
