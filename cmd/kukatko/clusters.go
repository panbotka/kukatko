...
// the cached listing summaries in the background, and the curator HTTP API.
...
// expose the admin recluster trigger. The curator guard is supplied via authAPI so
