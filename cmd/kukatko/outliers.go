...
// their embedding centroid) behind its editor/admin endpoint. The write guard is
// supplied via authAPI so the outlierapi package stays decoupled from auth's
// wiring.
