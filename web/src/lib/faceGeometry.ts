 ...
 * box is normalised against the ROTATED frame — which is the frame the viewer's
 * figure has, since the renditions carry the saved rotation and the figure takes
 * the shape of what it displays.
 *
